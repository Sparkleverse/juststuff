...
local skinMeta = {
	...
	["Bard"] = { "default", "Elderwood Bard", "Snow Day Bard", "Bloom Marigold Chroma", "Bloom Ivy Chroma", "Bloom Sage Chroma", "Bard Bard" }, 
	["Blitzcrank"] = { "default", "Rusty Blitzcrank", "Goalkeeper Blitzcrank", "Boom Boom Blitzcrank", "Piltover Customs Blitzcrank", "Definitely Not Blitzcrank", "iBlitzcrank", "Riot Blitzcrank",  "Molten Chroma", "Cobalt Chroma", "Gunmetal Chroma", "Battle Boss Blitzcrank", "Sewn Chaos Blitzcrank" }, 
	...
	["Caitlyn"] = { "default", "Resistance", "Sheriff", "Safari", "Arctic Warfare", "Officer", "Headhunter", "Pink Chroma", "Green Chroma", "Blue Chroma", "Lunar Wraith" }, 
	["Camille"] = { "default", "Program Camille" }, 
	["Cassiopeia"] = { "default", "Desperada", "Siren", "Mythic", "Day Chroma", "Dusk Chroma", "Night Chroma", "Jade Fang" }, 
	...
	["Darius"] = { "default", "Lord", "BioForge", "Woad King", "DunkMaster", "Black Iron Chroma", "Bronze Chroma", "Copper Chroma", "Academy", "Amethyst", "Aquamarine", "Catseye", "Citrine", "Emerald" }, 
	["Diana"] = { "default", "Dark Valkyrie Diana", "Lunar Goddess Diana", "Infernal Diana", "Amethyst Chroma", "Aquamarine Chroma", "Obsidian Chroma", "Pearl Chroma", "Ruby Chroma", "Peridot Chroma" }, 
	...
	["Ezreal"] = { "default", "Nottingham Ezreal", "Striker Ezreal", "Frosted Ezreal", "Explorer Ezreal", "Pulsefire Ezreal", "TPA Ezreal", "Debonair Ezreal", "Ace of Spades Ezreal", "Arcade Ezreal", "Amethyst Chroma", "Meteorite Chroma", "Obsidian Chroma", "Pearl Chroma", "Rose Quartz Chroma", "Ruby Chroma", "Sandstone Chroma", "Striped Chroma" }, 
	...
	["Fiora"] = { "default", "Royal Guard Fiora", "Nightraven Fiora", "Headmistress Fiora", "PROJECT: Fiora", "Pool Party Fiora", "Amethyst Chroma", "Catseye Chroma", "Jasper Chroma", "Pearl Chroma", "Rose Quartz Chroma", "Ruby Chroma", "Sandstone Chroma", "Sapphire Chroma" }, 
	["Fizz"] = { "default", "Atlantean Fizz", "Tundra Fizz", "Fisherman Fizz", "Void Fizz", "Orange Chroma", "Black Chroma", "Red Chroma", "Cottontail Fizz", "Super Galaxy Fizz" }, 
	...
	["Garen"] = { "default", "Sanguine Garen", "Desert Trooper Garen", "Commando Garen", "Dreadknight Garen", "Rugged Garen", "Steel Legion Garen", "Garnet Chroma", "Plum Chroma", "Ivory Chroma", "Rogue Admiral Garen", "Warring Kingdoms Garen" }, 
	...
	["Jax"] = { "default", "The Mighty Jax", "Vandal Jax", "Angler Jax", "PAX Jax", "Jaximus", "Temple Jax", "Nemesis Jax", "SKT T1 Jax", "Cream Chroma", "Amber Chroma", "Brick Chroma", "Warden Jax" }, 
	...
	["Karthus"] = { "default", "Phantom Karthus", "Statue of Karthus", "Grim Reaper Karthus", "Pentakill Karthus", "Burn Chroma", "Blight Chroma", "Frostbite Chroma", "Fnatic Karthus", "Karthus Lightsbane" }, 
	...
	["LeeSin"] = { "default", "Traditional Lee Sin", "Acolyte Lee Sin", "Dragon Fist Lee Sin", "Muay Thai Lee Sin", "Pool Party Lee Sin", "SKT T1 Lee Sin", "Black Chroma", "Blue Chroma", "Yellow Chroma", "Knockout Lee Sin" }, 
	["Leona"] = { "default", "Valkyrie Leona", "Defender Leona", "Iron Solari Leona", "Pool Party Leona", "Pink Chroma", "Lemon Chroma", "Azure Chroma", "PROJECT: Leona", "Barbecue Leona" }, 
	["Lissandra"] = { "default", "Bloodstone Lissandra", "Blade Queen Lissandra", "Program Lissandra" }, 
	["Lucian"] = { "default", "Hired Gun Lucian", "Striker Lucian", "Yellow Chroma", "Red Chroma", "Blue Chroma", "PROJECT: Lucian", "Heartseeker Lucian" }, 
	...
	["Malphite"] = { "default", "Shamrock Malphite", "Coral Reef Malphite", "Marble Malphite", "Obsidian Malphite", "Glacial Malphite", "Mecha Malphite", "Ironside Malphite", "Catseye Chroma", "Citrine Chroma", "Emerald Chroma", "Granite Chroma", "Obsidian Chroma", "Pearl Chroma", "Sandstone Chroma", "Sapphire Chroma" }, 
	...
	["MasterYi"] = { "default", "Assassin Master Yi", "Chosen Master Yi", "Ionia Master Yi", "Samurai Yi", "Headhunter Master Yi", "Gold Chroma", "Aqua Chroma", "Crimson Chroma", "PROJECT: Yi" }, 
	["MissFortune"] = { "default", "Cowgirl Miss Fortune", "Waterloo Miss Fortune", "Secret Agent Miss Fortune", "Candy Cane Miss Fortune", "Road Warrior Miss Fortune", "Mafia Miss Fortune", "Arcade Miss Fortune", "Captain Fortune", "Pool Party Miss Fortune", "Amethyst Chroma", "Aquamarine Chroma", "Citrine Chroma", "Peridot Chroma", "Ruby Chroma" }, 
	...
	["Morgana"] = { "default", "Exiled Morgana", "Sinful Succulence Morgana", "Blade Mistress Morgana", "Blackthorn Morgana", "Ghost Bride Morgana", "Victorious Morgana", "Toxic Chroma", "Pale Chroma", "Ebony Chroma", "Lunar Wraith Morgana", "Bewitching Morgana" }, 
	["Nami"] = { "default", "Koi Nami", "River Spirit Nami", "Sunbeam Chroma", "Smoke Chroma", "Twilight Chroma", "Urf the Nami-tee", "Deep Sea Nami" }, 
	["Nasus"] = { "default", "Galactic Nasus", "Pharaoh Nasus", "Dreadknight Nasus", "Riot K-9 Nasus", "Infernal Nasus", "Burn Chroma", "Blight Chroma", "Frostbite Chroma", "Archduke Nasus", "Worldbreaker Nasus" }, 
	...
	["Riven"] = { "default", "Redeemed Riven", "Crimson Elite Riven", "Battle Bunny Riven", "Championship Riven", "Dragonblade Riven", "Arcade Riven", "Championship Riven 2016", "Amethyst", "Astral", "Catseye", "Emerald", "Granite", "Rose Quartz", "Ruby", "Sapphire" }, 
	...
	["Teemo"] = { "default", "Happy Elf Teemo", "Recon Teemo", "Badger Teemo", "Astronaut Teemo", "Cottontail Teemo", "Super Teemo", "Panda Teemo", "Omega Squad Teemo", "Cottontail Chroma 1", "Cottontail Chroma 2", "Cottontail Chroma 3", "Cottontail Chroma 4", "Cottontail Chroma 5", "Little Devil Teemo" }, 
	["Thresh"] = { "default", "Deep Terror Thresh", "Championship Thresh", "Blood Moon Thresh", "SSW Thresh", "Dark Star Thresh" }, 
	["Tristana"] = { "default", "Riot Girl Tristana", "Earnest Elf Tristana", "Firefighter Tristana", "Guerilla Tristana", "Buccaneer Tristana", "Rocket Girl Tristana", "Navy Chroma", "Purple Chroma", "Orange Chroma", "Dragon Trainer Tristana", "Bewitching Tristana" }, 
	...
	["Vayne"] = { "default", "Vindicator Vayne", "Aristocrat Vayne", "Dragonslayer Vayne", "Heartseeker Vayne", "SKT T1 Vayne", "Arclight Vayne", "DragonSlayer Green", "DragonSlayer Red", "DragonSlayer Blue",  "Soulstealer Vayne" }, 
	...
	["XinZhao"] = { "default", "Commando Xin Zhao", "Imperial Xin Zhao", "Viscero Xin Zhao", "Winged Hussar Xin Zhao", "Warring Kingdoms Xin Zhao", "Secret Agent Xin Zhao","Amethyst", "Aquamarine Chroma", "Pearl Chroma", "Peridot Chroma", "Rose Quartz Chroma", "Ruby Chroma" }, 
	["Yasuo"] = { "default", "High Noon Yasuo", "PROJECT: Yasuo", "Blood Moon Yasuo", "Amethyst Chroma", "Emerald Chroma", "Jasper Chroma", "Obsidian Chroma", "Sapphire Chroma" }, 
	["Yorick"] = { "default", "Undertaker Yorick", "Pentakill Yorick" }, 
	["Zac"] = { "default", "Special Weapon Zac", "Orange Chroma", "Bubblegum Chroma", "Honey Chroma", "Pool Party Zac" }, 
	["Zed"] = { "default", "Shockblade Zed", "SKT T1 Zed", "PROJECT: Zed", "Amethyst Chroma", "Aquamarine Chroma", "Catseye Chroma", "Emerald Chroma", "Rose Quartz Chroma", "Ruby Chroma", "Championship Zed" }, 
